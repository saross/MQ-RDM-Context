...
\date{Wednesday 01 April 2020}                 % Today's date  
\begin{document}
...
%%% HASS material removed for BIOL7130 presentation
...
\begin{frame}{Challenges in HASS disciplines}
  In the current environment, we need to demonstrate how robust and reliable our research is. Considering the evidence we use, however, HASS faces legal and technical challenges to showing our work:
    \begin{itemize}[label=\textbullet]
        ...
        \item Technical: 'small data' problems, including diverse and heterogeneous data of various types, plus data and methods often emergent from research; harder than 'big data' in many ways, requires flexible and extensible infrastructure from a poorly coordinated and poorly funded domain \cite{Borgman2015-rh}.
        \cite{Rda2019-wc}.
    \end{itemize}
\end{frame}
...
Source code for this presentation is available at: \texttt{https://github.com/saross/Research-Transparency/releases/tag/v1.8}
